...
public class CategoriesController : BaseController
{
    ...
    public CategoriesController(INotificationHandler notification, UserHandler userHandler, CategoryService service)
    ...
    public async Task<IActionResult> Update(Guid id, [FromBody] CategoryDto dto)
    {
        ...
        if (userId == null) return Unauthorized();
        dto.Id = id;
        return HandleResponse(await _service.UpdateAsync(userId, dto));
    }
